...
#os.environ['SUMO_HOME'] = ''  # Update with your SUMO path
...
#duarouter_path = os.path.join(os.environ['SUMO_HOME'], 'bin', 'duarouter')
#duarouter_path = '/sfs/gpfs/tardis/project/SDS/research/shakeri-lab/VDOT2/SUMO/bin/duarouter'

#print("Path to duarouter:", duarouter_path)

# If the path exists, try to check if it is accessible
# if os.path.exists(duarouter_path):
#     print("duarouter binary found!")
# else:
#     print("duarouter binary not found!")
